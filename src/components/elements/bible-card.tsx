      ...
      <CardContent className="p-3 md:p-8 h-full flex flex-col justify-between relative">
        ...
        <div className="relative z-10">
          <div className="text-center mb-2 md:mb-6">
            <h1 className="text-lg md:text-3xl font-bold text-indigo-800 mb-1 md:mb-2">{card.mainTitle}</h1>
            <div className="flex justify-center mb-2 md:mb-4">
              <div className="w-12 md:w-20 h-1 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full"></div>
            </div>
            <h2 className="text-sm md:text-xl font-semibold text-gray-700 mb-1 md:mb-2">{card.subTitle}</h2>
            {card.subSubTitle && (
              <h3 className="text-xs md:text-base font-medium text-gray-600">{card.subSubTitle}</h3>
            )}
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center relative z-10">
          <div className="text-center w-full px-2">
            <p className="text-sm md:text-lg font-medium text-indigo-600 mb-1 md:mb-3">({card.reference})</p>
              ...
              >
                {isVerseVisible ? (
                  <div className="min-h-[6rem] md:min-h-[10rem] flex items-center justify-center w-full">
                    <blockquote className="text-xs md:text-lg leading-relaxed text-gray-800 font-medium transition-all duration-300 w-full max-w-full">
                      {card.verse}
                    </blockquote>
                  </div>
                ) : (
                  <div className="min-h-[10rem] md:min-h-[14rem] flex flex-col items-center justify-center w-full px-8 md:px-16">
                    ...
                    <div className="w-full flex justify-center">
                      <p className="text-xl md:text-3xl text-indigo-600 font-medium text-center">클릭하여 구절 보기</p>
                    </div>
                  </div>
                )}
              </div>
