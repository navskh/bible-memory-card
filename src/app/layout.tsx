...
import TestUpdateButton from "@/components/elements/test-update-button";
...
export default function RootLayout({
  ...
  return (
    <html lang="ko">
      <head>
        <meta name="application-name" content="성경 암송 앱" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="성경 암송" />
        <meta name="description" content="성경 구절을 효과적으로 암송할 수 있는 PWA 앱" />
